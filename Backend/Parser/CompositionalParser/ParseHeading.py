from Entities.Compositional.Heading import Heading
...
class ParseHeading:
    ...
    def parse(self, element):
        ...
        color_part = element[:element.find("heading")]
        ...
        el = Heading(font_p.to_json(), background_color, text)
        return el.to_json()


if __name__ == "__main__":
    p = ParseHeading()
    print(p.parse(" A purple heading with bold and italic red text \"hello from the other side\" of 55 pixels."))
